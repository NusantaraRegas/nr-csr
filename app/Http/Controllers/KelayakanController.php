...
class KelayakanController extends Controller
{
   ...
   public function exportKelayakan(Request $request)
    ...
    public function submitOld(Request $request)
    {
        ...
        $next_level = $detailApproval->level + 1;
        
        if($kelayakan->status == 'Evaluasi'){
                
                if($detailApproval->level == 1){
                    $nextApprover = ViewHirarki::where('username', $evaluasi->evaluator2)->where('level', $next_level)->where('status', 'Active')->first();
                }else{
                    $nextApprover = ViewHirarki::where('level', $next_level)->where('status', 'Active')->first();
                }
                ...
                if(!empty($nextApprover)){
                    ...
                    $status_kelayakan = 'Evaluasi';
                    $keterangan = 'Submit persetujuan evaluasi proposal';
                    ...
                    }elseif($detailApproval->level == 2){
                        $dataEvaluasi = [
                            'status' => 'Approved 2',
                            'catatan2' => $request->catatan,
                            'approve_date' => now(),
                        ];
                    }elseif($detailApproval->level == 3){
                        $dataEvaluasi = [
                            'status' => 'Approved 3',
                            'ket_kadin1' => $request->catatan,
                            'approve_kadep' => now(),
                        ];
                    }elseif($detailApproval->level == 4){
                        $dataEvaluasi = [
                            'status' => 'Survei',
                            'ket_kadiv' => $request->catatan,
                            'approve_kadiv' => now(),
                        ];
                    }

                    DB::table('tbl_detail_approval')->insert($dataApproval);
                    DB::table('tbl_evaluasi')->where('id_kelayakan', $kelayakanID)->update($dataEvaluasi);

                    //SEND EMAIL
                    $receiver = User::where('id_user', $nextApprover->id_user)->first();
                    $dataEmail = [
                    ...
                    $status_approval = 'Approved';
                    $status_kelayakan = 'Survei';
                    $keterangan = 'Menyetujui evaluasi proposal';
                    ...
                    //SEND EMAIL
                    $receiver = User::where('id_user', $kelayakan->created_by)->first();
                    $dataEmail = [
                        'nama_penerima' => $receiver->nama,
                        'phase' => $kelayakan->status,
                        'id' => $kelayakan->id_kelayakan,
            ...
            if (!$proker) {
                ...
                if($detailApproval->level == 1){
                    $nextApprover = ViewHirarki::where('username', $survei->survei2)->where('level', $next_level)->where('status', 'Active')->first();
                }else{
                    $nextApprover = ViewHirarki::where('level', $next_level)->where('status', 'Active')->first();
                }
                ...
                if(!empty($nextApprover)){
                    ...
                    $status_kelayakan = 'Survei';
                    $keterangan = 'Submit persetujuan survei proposal';
                    ...
                    if($detailApproval->level == 1){
                        $dataSurvei = [
                            'status' => 'Forward',
                            'hasil_survei' => $request->catatan,
                            'nilai_approved' => $survei->nilai_bantuan,
                            'create_date' => now(),
                        ];
                    }elseif($detailApproval->level == 2){
                        $dataSurvei = [
                            'status' => 'Approved 1',
                            'hasil_konfirmasi' => $request->catatan,
                            'nilai_approved' => $survei->nilai_bantuan,
                            'approve_date' => now(),
                        ];
                    }elseif($detailApproval->level == 3){
                    ...
                    DB::table('tbl_detail_approval')->insert($dataApproval);
                    DB::table('tbl_survei')->where('id_kelayakan', $kelayakanID)->update($dataSurvei);
                    ...
                    $status_approval = 'Approved';
                    $status_kelayakan = 'Approved';
                    $keterangan = 'Menyetujui survei proposal';
                    ...
                    $survei = Survei::where('id_kelayakan', $kelayakan->id_kelayakan)->first();
        ...
        try {
            ...
            DB::table('tbl_detail_approval')->where('id', $detailApproval->id)->update($dataUpdateApproval);
            DB::commit();
    ...
    public function cariBulan(Request $request)
    {
        ...
        return redirect()->route('dataBulan', ['bulan' => $request->bulan, 'tahun' => $request->tahun]);
    }
    ...
    public function cariPeriode(Request $request)
    {
        ...
        if($request->checkBookWilayah == '' and $request->checkBookPilar == '' and $request->checkBookJenis == ''){
            $this->validate($request, [
                'tanggal1' => 'required',
                'tanggal2' => 'required',
            ]);
            ...
            return redirect()->route('data-periode', ['tanggal1' => strtoupper($tglAwal), 'tanggal2' => strtoupper($tglAkhir)]);
        }elseif ($request->checkBookWilayah != '' and $request->checkBookPilar == '' and $request->checkBookJenis == ''){
            $this->validate($request, [
                'tanggal1' => 'required',
                'tanggal2' => 'required',
                'provinsi' => 'required',
            ...
            return redirect()->route('data-provinsi', ['tanggal1' => strtoupper($tglAwal), 'tanggal2' => strtoupper($tglAkhir), 'provinsi' => $request->provinsi, 'kabupaten' => encrypt($request->kabupaten)]);
        }elseif ($request->checkBookWilayah != '' and $request->checkBookPilar != '' and $request->checkBookJenis == ''){
            $this->validate($request, [
                'tanggal1' => 'required',
                'tanggal2' => 'required',
            ...
            return redirect()->route('dataProvinsiSDGs', ['tanggal1' => strtoupper($tglAwal), 'tanggal2' => strtoupper($tglAkhir), 'provinsi' => $request->provinsi, 'kabupaten' => encrypt($request->kabupaten), 'pilar' => $request->pilar, 'gols' => $request->gols]);
        }elseif ($request->checkBookWilayah != '' and $request->checkBookPilar == '' and $request->checkBookJenis != ''){
            $this->validate($request, [
                'tanggal1' => 'required',
                'tanggal2' => 'required',
            ...
            return redirect()->route('dataProvinsiJenis', ['tanggal1' => strtoupper($tglAwal), 'tanggal2' => strtoupper($tglAkhir), 'provinsi' => $request->provinsi, 'kabupaten' => encrypt($request->kabupaten), 'jenis' => $request->jenis]);
            ...
            return redirect()->route('dataProvinsiSDGsJenis', ['tanggal1' => strtoupper($tglAwal), 'tanggal2' => strtoupper($tglAkhir), 'provinsi' => $request->provinsi, 'kabupaten' => encrypt($request->kabupaten), 'pilar' => $request->pilar, 'gols' => $request->gols, 'jenis' => $request->jenis]);
        }elseif ($request->checkBookWilayah == '' and $request->checkBookPilar != '' and $request->checkBookJenis == ''){
            $this->validate($request, [
                'tanggal1' => 'required',
                'tanggal2' => 'required',
            ...
            return redirect()->route('dataSDGs', ['tanggal1' => strtoupper($tglAwal), 'tanggal2' => strtoupper($tglAkhir), 'pilar' => $request->pilar, 'gols' => $request->gols]);
        }elseif ($request->checkBookWilayah == '' and $request->checkBookPilar != '' and $request->checkBookJenis != ''){
            $this->validate($request, [
                'tanggal1' => 'required',
                'tanggal2' => 'required',
            ...
            return redirect()->route('dataSDGsJenis', ['tanggal1' => strtoupper($tglAwal), 'tanggal2' => strtoupper($tglAkhir), 'pilar' => $request->pilar, 'gols' => $request->gols, 'jenis' => $request->jenis]);
        }elseif ($request->checkBookWilayah == '' and $request->checkBookPilar == '' and $request->checkBookJenis != ''){
            $this->validate($request, [
                'tanggal1' => 'required',
                'tanggal2' => 'required',
            ...
            return redirect()->route('dataJenis', ['tanggal1' => strtoupper($tglAwal), 'tanggal2' => strtoupper($tglAkhir), 'jenis' => $request->jenis]);
        }else{
            $this->validate($request, [
                'tanggal1' => 'required',
                'tanggal2' => 'required',
