...
class RealisasiPrioritasExport implements FromView, ShouldAutoSize, WithStyles, WithEvents, WithTitle
{
    protected $data;
    protected $tahun;
    ...
    {
        return view('export.rekap_realisasi_prioritas', [
            'tahun' => $this->tahun,
            'dataPrioritas' => $this->data,
        ]);
    }
    ...
    {
        return 'Realisasi Prioritas ' . $this->tahun;
    }
}