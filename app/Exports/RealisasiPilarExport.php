...
class RealisasiPilarExport implements FromView, ShouldAutoSize, WithStyles, WithEvents, WithTitle
{
    protected $data;
    protected $tahun;
    ...
    {
        return view('export.rekap_realisasi_pilar', [
            'tahun' => $this->tahun,
            'dataPilar' => $this->data,
        ]);
    }
    ...
    {
        return 'Realisasi Pilar ' . $this->tahun;
    }
}