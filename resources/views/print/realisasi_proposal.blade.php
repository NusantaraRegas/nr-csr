                    ...
                    <td bgcolor="#ffffff" colspan="2" height="100%"><br>
                        <table border="1" rules="all" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            @foreach($dataPayment as $data)
                                <tr>
                                    <td nowrap style="text-align: center; padding-right: 5px; padding-left: 5px">{{ date('d-m-Y', strtotime($data['action_date'])) }}</td>
                                    <td style="text-align: center; padding-right: 5px; padding-left: 5px">{{ $data['id'] }}</td>
                                    ...
                                    <td style="text-align: center; padding-right: 5px; padding-left: 5px">{{ $data['attribute1'] }}</td>
