...
@section('title', 'SHARE | Proposal Santunan')

@section('content')
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="font-weight-bold model-huruf-family">PROPOSAL SANTUNAN</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Proposal Santunan</li>
                    </ol>
                    <button type="button" class="btn btn-success d-lg-block ml-3" data-target=".modalImport"
                        data-toggle="modal"><i class="fa fa-upload mr-2"></i>Upload Data</button>
                </div>
            </div>
        </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control text-uppercase" name="noAgenda"
                                        value="0002/SAN/CSR/IV/2022.">
                                    <input type="hidden" class="form-control" name="jenis" value="Santunan">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" onkeypress="return hanyaAngka(event)" class="form-control"
                                        name="perkiraanDana" id="perkiraanDana" value="6.250.000">
    ...
    <form method="post" action="{{ action('LaporanController@uploadKelayakan') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="modal fade modalImport" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title font-weight-bold model-huruf-family">Upload Data</h4>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <a style="color: blue" target="_blank"
                                href="{{ asset('file_upload/data_kelayakan.xlsx') }}">Download format file</a>
                        </div>
                    </div>
