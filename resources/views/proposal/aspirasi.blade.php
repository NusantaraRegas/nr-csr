...
@section('title', 'SHARE | Proposal Aspirasi')

@section('content')
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="font-weight-bold model-huruf-family">PROPOSAL ASPIRASI</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Proposal Aspirasi</li>
                    </ol>
                </div>
            </div>
        </div>

        <form method="post" action="{{ action('KelayakanController@insertKelayakan') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-12">
                    @if (count($errors) > 0)
            ...
            <div class="row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control text-uppercase" name="noAgenda"
                                        value="{{ old('noAgenda') }}">
                                    <input type="hidden" class="form-control" name="jenis" value="Aspirasi">
                        ...
                        <div class="card-footer">
                            <div class="btn-group pull-right" role="group" aria-label="Basic example">
                                ...
                                <button type="submit" disabled class="btn btn-success waves-effect text-left"
                                    id="submit_button">Save as draft</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="3" maxlength="200" class="form-control bg-white" placeholder="Otomatis by system"
                                    name="alamat" id="alamat" readonly>{{ old('alamat') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="pengajuProposal"
                                    id="pengajuProposal" readonly value="{{ old('pengajuProposal') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="bertindakSebagai"
                                    id="bertindakSebagai" readonly value="{{ old('bertindakSebagai') }}"
                                    placeholder="Otomatis by system">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" onkeypress="return hanyaAngka(event)" class="form-control bg-white"
                                    readonly id="noTelp" placeholder="Otomatis by system" value="{{ old('noTelp') }}"
                                    name="noTelp">
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" maxlength="35" onkeypress="return hanyaAngka(event)"
                                        ...
                                        name="noRekening" value="{{ old('noRekening') }}" id="noRekening">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="namaBank" id="namaBank"
                                    value="{{ old('namaBank') }}" readonly placeholder="Otomatis by system">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control bg-white" name="kota" id="kota"
                                        readonly placeholder="Otomatis by system" value="{{ old('kota') }}">
                    ...
                    <div class="card">
                        <div class="card-header bg-info">
                            <h4 class="m-b-0 text-white model-huruf-family">Anggota</h4>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <label>Nama Anggota <span class="text-danger">*</span></label>
                                <select class="select2 form-control" style="width: 100%" name="namaAnggota"
                                    id="namaAnggota">
                                    <option>{{ old('namaAnggota') }}</option>
                                    @foreach ($dataAnggota as $anggota)
                                        <option fraksi="{{ $anggota->fraksi }}" komisi="{{ $anggota->komisi }}"
                                            jabatan="{{ $anggota->jabatan }}"
                                            pic="{{ $anggota->staf_ahli }} - {{ $anggota->no_telp }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="fraksi" id="fraksi"
                                    value="{{ old('fraksi') }}" placeholder="Otomatis by system" readonly>
                                @if ($errors->has('fraksi'))
                                    <small class="text-danger">Fraksi harus diisi</small>
                                @endif
                            </div>
                            <div class="form-group">
                                <label>Komisi <span class="text-danger">*</span></label>
                                <input type="text" class="form-control bg-white" name="komisi" id="komisi"
                                    value="{{ old('komisi') }}" placeholder="Otomatis by system" readonly>
                                @if ($errors->has('komisi'))
                                    <small class="text-danger">Komisi harus diisi</small>
                                @endif
                            </div>
                            <div class="form-group">
                                <label>Jabatan <span class="text-danger">*</span></label></label>
                                <input type="text" class="form-control bg-white" name="jabatan" id="jabatan"
                                    value="{{ old('jabatan') }}" placeholder="Otomatis by system" readonly>
                                @if ($errors->has('jabatan'))
                                    <small class="text-danger">Jabatan harus diisi</small>
                                @endif
                            </div>
                            <div class="form-group">
                                <label>Contact TA/PIC <span class="text-danger">*</span></label></label>
                                <input type="text" class="form-control bg-white" name="pic" id="pic"
                                    value="{{ old('pic') }}" placeholder="Otomatis by system" readonly>
                                @if ($errors->has('pic'))
                                    <small class="text-danger">Contact TA/PIC harus diisi</small>
                                @endif
                            </div>
                        </div>
                    </div>
...
@section('footer')
    ...
    <script>
        $('#namaAnggota').on('change', function() {
            var fraksi = $('#namaAnggota option:selected').attr('fraksi');
            var komisi = $('#namaAnggota option:selected').attr('komisi');
            var jabatan = $('#namaAnggota option:selected').attr('jabatan');
            var pic = $('#namaAnggota option:selected').attr('pic');
            $('#fraksi').val(fraksi);
            $('#komisi').val(komisi);
            $('#jabatan').val(jabatan);
            $('#pic').val(pic);
