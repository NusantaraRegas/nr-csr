...
@section('title', 'SHARE | Proposal Bulanan')

@section('content')
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="font-weight-bold model-huruf-family">PROPOSAL BULANAN</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Proposal Bulanan</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control text-uppercase" name="noAgenda"
                                        value="{{ old('noAgenda') }}">
                                    <input type="hidden" class="form-control" name="jenis" value="Bulanan">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check mr-sm-2 mb-3">
                                <input type="checkbox" class="form-check-input" name="smap" id="checkboxAgreement"
                                    value="Yes" onclick="terms_changed(this)">
                                ...
                                @if ($errors->has('smap'))
                                    <br>
                                    <small class="text-danger">Check this statement</small>
                                @endif
                            </div>
                        </div>
