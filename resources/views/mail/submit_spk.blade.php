...
<div class='container'>
    <p>Yth, {{ $penerima }}</p>
    <p>Sehubungan dengan pelaksanaan {{ $namaProyek }} dengan ini kami sampaikan Surat Perintah Kerja dengan rincian sebagai berikut :</p>
    <table>
        <tr>
            <td style="padding-right: 10px; vertical-align: top">Nomor</td>
            <td style="padding-right: 10px; vertical-align: top">:</td>
            <td style="vertical-align: top">{{ $no_spk }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="padding-right: 10px; vertical-align: top">Durasi Pekerjaan</td>
            <td style="padding-right: 10px; vertical-align: top">:</td>
            <td style="vertical-align: top">{{ $durasi." Hari" }}</td>
        </tr>
        <tr>
            <td style="padding-right: 10px; vertical-align: top">Tanggal Penyelesaian</td>
            <td style="padding-right: 10px; vertical-align: top">:</td>
