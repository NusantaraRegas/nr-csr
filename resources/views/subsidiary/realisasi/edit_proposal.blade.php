...
@section('title', 'PGN SHARE | Edit Realisasi Proposal')
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="font-weight-bold model-huruf-family">EDIT REALISASI PROPOSAL
                    <br>
        ...
        <form method="post" action="{{ action('RealisasiSubsidiaryController@updateProposal') }}"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="date-start"
                                               ...
                                               value="{{ date('d-M-Y', strtotime($data->tgl_proposal)) }}">
