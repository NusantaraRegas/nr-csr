...
@section('title', 'PGN SHARE | Alokasi Program Kerja')
...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <button type="button" data-toggle="modal" data-target=".modal-input"
                        class="btn btn-info d-lg-block m-l-15"><i class="fa fa-plus-circle mr-2"></i>Tambah Anggaran
                    </button>
        ...
        @if ($anggaran > 0)
            <div class="card-group">
                ...
                <div class="card">
                    <?php
                    $alokasiPilar = DB::table('tbl_proker')->select(DB::raw('pilar, sum(anggaran) as total'))->where('tahun', $tahun)->where('perusahaan', $comp)->groupBy('pilar')->get();
                    
                    $alokasiPrioritas = DB::table('tbl_proker')->select(DB::raw('prioritas, sum(anggaran) as total'))->where('tahun', $tahun)->where('perusahaan', $comp)->groupBy('prioritas')->get();
                    ?>
                    <div class="card-body">
                            ...
                            @if ($jumlahData > 0)
                                <div class="table-responsive">
                                    <table class="example5 table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th width="50px" class="text-center font-weight-bold" nowrap>Proker ID
                                                </th>
    ...
    <form method="GET" action="{{ route('indexProkerSubsidiary') }}" class="modal-content">
        @csrf
        <div class="modal fade modal-filter" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title font-weight-bold"><i class="fa fa-filter mr-2"></i>Filter Data</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('indexProkerSubsidiary') }}" class="btn btn-outline-danger">Reset</a>
