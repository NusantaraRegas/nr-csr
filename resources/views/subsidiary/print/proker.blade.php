...
<html lang="en">
<head>
    <title>Alokasi Program Kerja</title>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <b style="font-size:16px;">ALOKASI PROGRAM KERJA TAHUN {{ $tahun }}</b><br>
                        ...
                        <table border="1" rules="all" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            @foreach($dataProker as $data)
                                <tr>
                                    ...
                                    <td nowrap
                                        style="text-align: right; padding: 5px 5px 5px 5px; vertical-align: top">{{ number_format($data->anggaran,0,',','.') }}
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
