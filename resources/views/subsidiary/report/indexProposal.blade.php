...
@section('content')
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <a href="{{ route('indexRealisasiSubsidiary') }}" class="btn btn-danger d-none d-lg-block m-l-15"><i
    ...
    <form method="GET" action="{{ route('indexRealisasiSubsidiary') }}" class="modal-content">
        @csrf
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('indexRealisasiSubsidiary') }}" class="btn btn-outline-danger">Reset</a>
