...
@section('title', 'NR SHARE | Laporan Realisasi Non Proposal')
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split active"
                            ...
                            <div class="ml-auto">
                                @if ($jumlahData > 0)
                                    <a href="{{ route('exportRealisasiProposalSubsidiary', ['year' => $tahun, 'company' => $comp]) }}"
                                        class="btn btn-sm active btn-secondary"><i class="fa fa-file-text-o mr-2"></i>Export
                                        Excel</a>
                                ...
                                <table class="example5 table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center font-weight-bold" width="200px" nowrap>Program Kerja
                                            </th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" nowrap>
                                                    @if ($data->status == 'In Progress')
                                                        <span class="badge badge-warning" style="color: black">In
                                                            Progress</span>
