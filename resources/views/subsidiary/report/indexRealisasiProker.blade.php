        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <button class="btn btn-info d-lg-block ml-3" data-target=".modalFilterAnnual" data-toggle="modal"><i
                            class="fa fa-filter mr-2"></i>Budget Year
                    </button>
                </div>
            </div>
        </div>
                            ...
                            @if ($jumlahData > 0)
                                <div class="table-responsive">
                                    <table class="example5 table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th width="100px" class="text-center font-weight-bold" nowrap>Proker ID
                                                </th>
                                        ...
                                        <tbody>
                                            @foreach ($dataProker as $data)
                                                <?php
                                                $totalRealisasi = DB::table('tbl_realisasi_ap')->select(DB::raw('SUM(nilai_bantuan) as total'))->where('perusahaan', $comp)->where('tahun', $tahun)->where('id_proker', $data->id_proker)->first();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a target="_blank"
                                                            ...
                                                            style="color: blue">{{ $data->proker }}</a>
                                                        @if ($data->prioritas != '')
                                                            <br>
                                                    ...
                                                    <td class="text-right">
                                                        @if ($sisa >= 0)
                                                            <span
                                                                class="font-weight-bold">{{ number_format($sisa, 0, ',', '.') }}</span>
                                                        @else
