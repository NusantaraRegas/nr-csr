...
@section('content')
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="font-weight-bold">
                    DETAIL REALISASI ANGGARAN CSR TAHUN {{ $tahun }}
                    <br>
                    <small class="text-danger">{{ $perusahaanAktif->nama_perusahaan }}</small>
                </h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <button type="button" data-toggle="modal" data-target=".modalFilterAnnual"
                        ...
                        @if ($jumlahData > 0)
                            <div class="d-flex">
                                <div>
                                    ...
                                    <h3 class="card-subtitle mb-5 text-dark font-weight-bold">
                                ...
                                <table class="example5 table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center font-weight-bold" width="300px" nowrap>Program Kerja
                                            </th>
                                            ...
                                            <th class="text-center font-weight-bold" width="100px" nowrap>Jumlah (Rp)
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($dataRealisasi as $data)
                                            <tr>
                                                ...
                                                <td class="text-center" nowrap>
                                                    {{ date('d-m-Y', strtotime($data->tgl_realisasi)) }}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <b
                                                        class="font-weight-bold text-uppercase">{{ $data->nama_yayasan }}</b><br>
    ...
    <form method="GET" action="{{ route('detailRealisasiSubsidiary') }}" class="modal-content">
        @csrf
        <div class="modal fade modalFilterAnnual" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title font-weight-bold model-huruf-family"><i class="fa fa-filter mr-2"></i>Filter
                            Data</h4>
                            ...
                            <select class="form-control" name="perusahaan" style="width: 100%">
                                @foreach ($dataPerusahaan as $perusahaan)
                                    <option value="{{ $perusahaan->id_perusahaan }}"
                                        {{ (string) $comp === (string) $perusahaan->id_perusahaan ? 'selected' : '' }}>
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('detailRealisasiSubsidiary') }}" class="btn btn-outline-danger">Reset</a>
    ...
    <form method="post" action="{{ action('ReportSubsidiaryController@postRealisasiSubsidiaryMonthly') }}">
        {{ csrf_field() }}
        <div class="modal fade modalFilterMonthly" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="provinsi" id="provinsi">
                                ...
                                @foreach ($dataProvinsi as $provinsi)
                                    <option value="{{ ucwords($provinsi->provinsi) }}">{{ ucwords($provinsi->provinsi) }}
                                    </option>
                                @endforeach
                            </select>
