...
@section('content')
    ...
    <div class="container-fluid model-huruf-family">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="font-weight-bold model-huruf-family">LAPORAN REALISASI ANGGARAN
                    <br>
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Realisasi CSR 517</li>
                    </ol>
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-info active dropdown-toggle dropdown-toggle-split active"
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="{{ route('listRealisasiAll') }}">Reset</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div>
                                <h4 class="card-title model-huruf-family">TOTAL REALISASI</h4>
                                <h2 class="card-subtitle font-weight-bold m-t-0">
                                    {{ 'Rp' . number_format($total, 0, ',', '.') }}
                                </h2>
                            </div>
                            <div class="ml-auto">
                                <a href="{{ route('exportRealisasiAll', $tahun) }}"
                                    class="btn active btn-sm btn-secondary"><i class="fa fa-file-text-o mr-2"></i>Export
                                    Excel</a>
                                <a href="{{ route('printRealisasiAll', $tahun) }}" target="_blank"
                            ...
                            <table class="example5 table table-striped table-hover table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center" width="200px">Penerima</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($dataPayment as $data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{--                                            @if ($data['attribute2'] != '') --}}
                                                {{--                                                <br> --}}
                                                {{--                                                <b class="font-weight-bold text-info">{{ $data['attribute2'] }}</b> --}}
                                                {{--                                            @endif --}}
                                            </td>
                                            ...
                                            <td nowrap>{{ $data['supplier_name'] }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
    ...
    <form method="post" action="{{ action('APIController@postRealisasiAllAnnual') }}">
        {{ csrf_field() }}
    ...
    <form method="post" action="{{ action('APIController@listPaymentRequestProposalPeriodePAID') }}">
        {{ csrf_field() }}
