                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item"
                                            href="{{ route('exportRealisasiProposalPeriode', ['tanggal1' => "$tanggal1", 'tanggal2' => "$tanggal2"]) }}"><i
                                                class="fa fa-file-excel-o mr-2"></i>Export Excel</a>
                                        <a class="dropdown-item" target="_blank"
                                            href="{{ route('printPaymentRequestProposalPeriode', ['tanggal1' => "$tanggal1", 'tanggal2' => "$tanggal2"]) }}"><i
