...
@section('content')
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Realisasi Prioritas</li>
                    </ol>
                    <a href="{{ route('indexRealisasiPrioritas') }}" class="btn btn-danger d-none d-lg-block m-l-15"><i
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <div class="ml-auto">
                                <a href="{{ route('exportRealisasiPrioritas', request()->query()) }}"
                        ...
                        @else
                            <div class="text-center py-4">
                                ...
                                <h5 class="mt-3">Data realisasi prioritas tidak ditemukan</h5>
    ...
    <div class="modal fade modal-filter" tabindex="-1" role="dialog" aria-labelledby="filterModalLabel"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <form method="GET" action="{{ route('indexRealisasiPrioritas') }}" class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{ route('indexRealisasiPrioritas') }}" class="btn btn-outline-danger">Reset</a>
