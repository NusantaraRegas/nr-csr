    ...
    <div class="container-fluid model-huruf-family">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="font-bold text-uppercase">REALISASI PROPOSAL</h4>
            </div>
            ...
            <div class="col-12">
                <div class="card model-huruf-family">
                    <div class="card-header bg-primary">
                        <h4 class="m-b-0 text-white"><i class="fa fa-filter mr-2"></i>FILTER PROPOSAL</h4>
                    </div>
                    <!-- Nav tabs -->
                    <ul class="nav nav-tabs customtab" role="tablist">
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#home2" role="tab"><span
                                    class="hidden-sm-up"><i class="fa fa-calendar"></i></span> <span
                                    class="hidden-xs-down">PERIODE</span></a></li>
                        {{--                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#profile2" role="tab"><span --}}
                        {{--                                        class="hidden-sm-up"><i class="fa fa-handshake-o"></i></span> <span --}}
                        {{--                                        class="hidden-xs-down">SEKTOR</span></a></li> --}}
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#messages2"
                                role="tab"><span class="hidden-sm-up"><i class="fa fa-bank"></i></span> <span
                                    class="hidden-xs-down">PROVINSI</span></a></li>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content">
                        <div class="tab-pane" id="home2" role="tabpanel">
                            <div class="p-20">
                                <form method="post"
                                    action="{{ action('APIController@listPaymentRequestProposalPeriodePAID') }}">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-3">
                        ...
                        {{--                            <form method="post" action="{{ action('KelayakanController@cariSektor') }}"> --}}
                        {{--                                {{ csrf_field() }} --}}
                        {{--                                <div class="row"> --}}
                        {{--                                    <div class="col-md-3"> --}}
                        {{--                                        <div class="form-group"> --}}
                        ...
                        {{--                                            </select> --}}
                        {{--                                            @if ($errors->has('tahun')) --}}
                        {{--                                                <small class="text-danger">Periode tahun harus diisi</small> --}}
                        {{--                                            @endif --}}
                        {{--                                        </div> --}}
                        {{--                                    </div> --}}
                        {{--                                    <div class="col-md-3"> --}}
                        ...
                        <div class="tab-pane active p-20" id="messages2" role="tabpanel">
                            <form method="post"
                                action="{{ action('APIController@listPaymentRequestProposalProvinsiPAID') }}">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            @if ($errors->has('provinsi'))
                                                <small class="text-danger">Provinsi bantuan harus diisi</small>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item"
                                            href="{{ route('exportRealisasiProposalProvinsi', ['tahun' => "$tahun", 'provinsi' => "$prov"]) }}"><i
                                                class="fa fa-file-excel-o mr-2"></i>Export Excel</a>
                                        {{--                                        <a class="dropdown-item" target="_blank" href="{{ route('printPaymentRequestProposal', $tahun) }}"><i class="fa fa-print mr-2"></i>Print</a> --}}
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="{{ route('listPaymentRequestProposalPAID') }}"><i
                            ...
                            <table id="myTable" class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="100px" rowspan>PR ID</th>
