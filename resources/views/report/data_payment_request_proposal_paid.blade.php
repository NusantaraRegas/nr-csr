                ...
                <div class="card model-huruf-family">
                    ...
                    <ul class="nav nav-tabs customtab" role="tablist">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#home2"
                                role="tab"><span class="hidden-sm-up"><i class="fa fa-calendar"></i></span> <span
                            ...
                            <div class="ml-auto">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{ route('exportRealisasiProposal', $tahun) }}"><i
                                                class="fa fa-file-excel-o mr-2"></i>Export Excel</a>
                                        <a class="dropdown-item" target="_blank"
                                            href="{{ route('printPaymentRequestProposal', $tahun) }}"><i
