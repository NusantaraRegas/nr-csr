                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" autofocus class="form-control" name="namaLembaga" value="{{ old('namaLembaga') }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" maxlength="150" class="form-control"
                                                       placeholder="Maksimal 35 Karakter" name="atasNama" value="{{ old('atasNama') }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input maxlength="35" type="text"
                                                       class="form-control"
                                                       placeholder="Maksimal 35 Karakter" name="cabang" value="{{ old('cabang') }}">
