...
@section('title', 'PGN SHARE | Edit Realisasi Non Proposal')
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="font-weight-bold model-huruf-family">EDIT REALISASI ANGGARAN CSR
                    <br>
        ...
        <form method="post" action="{{ action('RealisasiSubsidiaryController@updateNonProposal') }}"
                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" class="form-control" name="realisasiID" value="{{ encrypt($data->id_realisasi) }}">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                               ...
                                               name="tglRealisasi" value="{{ date('d-M-Y', strtotime($data->tgl_realisasi)) }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control bg-white text-dark" name="proker"
                                           id="proker" readonly value="{{ $data->proker }}">
                                    <div class="input-group-append">
                                    ...
                                    <input type="hidden" class="form-control" name="prokerID" id="prokerID" value="{{ $data->id_proker }}">
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control bg-white text-dark" name="prioritas" id="prioritas"
                                           readonly value="{{ $data->prioritas }}">
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-capitalize" name="deskripsi" value="{{ $data->deskripsi }}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control bg-white text-dark custom-select" name="anggaranTersedia"
                                        ...
                                        <option>{{ number_format($terpakai,0,',','.') }}</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="select2 form-control" name="namaYayasan" id="dari" style="width: 100%">
                                    <option>{{ $data->nama_yayasan }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white" name="jabatan"
                                       ...
                                       placeholder="" value="{{ $data->jabatan }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" onkeypress="return hanyaAngka(event)"
                                       class="form-control bg-white" readonly id="noTelp"
                                       placeholder=""
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="javascript:void(0)" class="pilih btn btn-sm btn-success"
                                           ...
                                           data-pilar="{{ $proker->pilar }}" data-gols="{{ $proker->gols }}" data-prioritas="{{ $proker->prioritas }}"><i
...
@section('footer')
    ...
    <script>
        $(document).on('click', '.pilih', function (e) {
            ...
            $.ajax({
                type: 'GET',
                url: "/subsidiary/realisasi/sisaAnggaran/" + proker_id + "",
