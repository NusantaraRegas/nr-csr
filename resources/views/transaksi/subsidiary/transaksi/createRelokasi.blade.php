...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="card">
                    ...
                    <form method="post" action="{{ action('RelokasiSubsidiaryController@store') }}">
                        {{ csrf_field() }}
                        <div class="card-body">
                            <div class="form-body">
                                <div class="form-group">
                                    <label>Sumber Anggaran <span
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label class="font-16">Anggaran Tersedia <span
                                                    class="text-danger">*</span></label>
                                        <select class="form-control form-control-lg bg-white text-dark custom-select"
                                                name="nominalAsal"
                                                id="nominalAsal" readonly>
                                            <option></option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="font-16">Jumlah Relokasi <span
                                                    class="text-danger">*</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button type="button" class="btn btn-secondary"
                                                    data-target=".modal-prokerTujuan"
                                                    data-toggle="modal"><i class="fa fa-search"></i></button>
                                        </div>
                                        <select style="display: none"
                                                class="form-control bg-white text-dark custom-select"
                                                name="nominalTujuan"
                                                id="nominalTujuan" readonly>
                                            <option></option>
                                        </select>
                        ...
                        <div class="card-footer text-right">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="{{ route('indexRelokasiSubsidiary') }}">
    ...
    <div class="modal fade modal-prokerTujuan" tabindex="-1" role="dialog" aria-hidden="true"
         style="display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
