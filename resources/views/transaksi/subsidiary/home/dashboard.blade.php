...
@section('content')
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <button type="button"
                            class="btn btn-info d-none d-lg-block m-l-15" data-target=".modalBudgetYear"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <span class="pie" data-peity='{ "fill": ["#1de9b6", "#f2f2f2"]}'>{{ round($realisasi / $anggaran * 100, 2) }},{{ round($sisa / $anggaran * 100, 2) }}</span>
                                            <br>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <span class="pie" data-peity='{ "fill": ["#f44236", "#f2f2f2"]}'>{{ round($sisa / $anggaran * 100, 2) }},{{ round($realisasi / $anggaran * 100, 2) }}</span>
                                            <br>
                                            <small class="text-muted">Status
                        ...
                        <div class="card">
                            ...
                            <table class="table-striped table-bordered" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th width="150px"
                                        style="text-align: center; padding: 5px 10px 5px 5px" class="font-weight-bold">Plan
                                    </th>
                                    <th width="150px"
                                        style="text-align: center; padding: 5px 10px 5px 5px" class="font-weight-bold">
                                        Realisasi
                                    </th>
                                </tr>
                                </thead>
                                ...
                                <tr>
                                    ...
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalPlanPilarSosial,0,',','.') }}</td>
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalActualPilarSosial,0,',','.') }}</td>
                                </tr>
                                <tr>
                                    <td width="300px" style="padding: 5px 5px 5px 10px">
                                        Ekonomi
                                    ...
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalPlanPilarEkonomi,0,',','.') }}</td>
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalActualPilarEkonomi,0,',','.') }}</td>
                                </tr>
                                <tr>
                                    <td width="300px" style="padding: 5px 5px 5px 10px">
                                        Lingkungan
                                    ...
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalPlanPilarLingkungan,0,',','.') }}</td>
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalActualPilarLingkungan,0,',','.') }}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <table class="table-striped table-bordered" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalPlanPrioritasPendidikan,0,',','.') }}</td>
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalActualPrioritasPendidikan,0,',','.') }}</td>
                                </tr>
                                <tr>
                                    <td width="300px" style="padding: 5px 5px 5px 10px">
                                        Lingkungan
                                    ...
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalPlanPrioritasLingkungan,0,',','.') }}</td>
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalActualPrioritasLingkungan,0,',','.') }}</td>
                                </tr>
                                <tr>
                                    <td width="300px" style="padding: 5px 5px 5px 10px">
                                        UMK
                                    ...
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalPlanPrioritasUMK,0,',','.') }}</td>
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalActualPrioritasUMK,0,',','.') }}</td>
                                </tr>
                                <tr>
                                    <td width="300px" style="padding: 5px 5px 5px 10px">
                                        Sosial/Ekonomi
                                    ...
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalPlanPrioritasSosialEkonomi,0,',','.') }}</td>
                                    <td width="150px"
                                        style="text-align: right; padding: 5px 10px 5px 5px">{{ number_format($totalActualPrioritasSosialEkonomi,0,',','.') }}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <form method="post" action="{{ action('DashboardSubsidiaryController@postBudgetYear') }}">
        {{ csrf_field() }}
...
@section('footer')
    ...
    <script>
        Highcharts.chart('container1', {
            ...
            series: [{
                name: 'Plan',
                data: [{{ $planPrioritasPendidikan }}, {{ $planPrioritasLingkungan }}, {{ $planPrioritasUMK }}, {{ $planPrioritasSosialEkonomi }}]

            }, {
                name: 'Realisasi',
                data: [{{ $actualPrioritasPendidikan }}, {{ $actualPrioritasLingkungan }}, {{ $actualPrioritasUMK }}, {{ $actualPrioritasSosialEkonomi }}]
